...
<section class="content-header">
    <h1>
        <?= __('Wykresy przebiegu w czasie (inline charts)') ?>
        <small><?= __('Różne typy wykresów') ?></small>
    </h1>
    <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> <?= __('Strona główna') ?></a></li>
        <li><a href="#"><?= __('Wykresy') ?></a></li>
        <li class="active"><?= __('Wykresy przebiegu w czasie (inline charts)') ?></li>
    </ol>
</section>
...
<section class="content">
                ...
                <div class="box-body">
                    <div class="row">
                        <div class="col-xs-6 col-md-3 text-center">
                            ...
                            <div class="knob-label"><?= __('Nowi odwiedzający') ?></div>
                        </div>
                        <!-- ./col -->
                        <div class="col-xs-6 col-md-3 text-center">
                            ...
                            <div class="knob-label"><?= __('Współczynnik odrzuceń') ?></div>
                        </div>
                        <!-- ./col -->
                        <div class="col-xs-6 col-md-3 text-center">
                            ...
                            <div class="knob-label"><?= __('Obciążenie serwera') ?></div>
                        </div>
                        <!-- ./col -->
                        <div class="col-xs-6 col-md-3 text-center">
                            ...
                            <div class="knob-label"><?= __('Miejsce na dysku') ?></div>
                        </div>
                        <!-- ./col -->
                    </div>
                    <!-- /.row -->
                    ...
                    <div class="row">
                        <div class="col-xs-6 text-center">
                            ...
                            <div class="knob-label"><?= __('Przepustowość') ?></div>
                        </div>
                        <!-- ./col -->
                        <div class="col-xs-6 text-center">
                            ...
                            <div class="knob-label"><?= __('CPU') ?></div>
                        </div>
                        <!-- ./col -->
                    </div>
                    <!-- /.row -->
        ...
        <div class="col-xs-12">
            <div class="box box-solid">
                <div class="box-header">
                    ...
                    <h3 class="box-title">jQuery Knob <?= __('różne wielkości') ?></h3>
        ...
        <div class="col-xs-12">
            <div class="box box-solid">
                <div class="box-header">
                    ...
                    <h3 class="box-title">jQuery Knob <?= __('w stylu Tron') ?></h3>
    ...
    <div class="callout callout-info">
        <h4><?= __('Poniższe wykresy utworzono przy użyciu tagów data') ?></h4>

        <p>The following three inline (sparkline) chart have been initialized to read and interpret data tags</p>
        <p><?= __('Poniższe trzy wykresy przebiegu w czasie (sparklines) zostały zainicjalizowane z opcją odczytu danych z tagów data') ?></p>
    </div>
    <!-- /.callout -->
    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="box box-solid">
                <div class="box-header">
                    <h3 class="box-title">Sparkline <?= __('przykłady') ?></h3>
                ...
                <div id="myBody" class="box-body">
                    <div class="row">
                        <div class="col-sm-6">
                            <p>
                                <?= __('Szybkość myszki') ?> <span id="mousespeed"><?= __('Ładowanie') ?>...</span>
                            </p>
                            ...
                            <p>
                                <?= __('Wykresy słupkowe') ?> <span class="sparkbar">10,8,9,3,5,8,5</span>
                                <?= __('wartości ujemne') ?>: <span class="sparkbar">-3,1,2,0,3,-1</span>
                                <?= __('stos') ?>: <span class="sparkbar">0:2,2:4,4:2,4:1</span>
                            </p>
                            ...
                            <p>
                                ...
                                <?= __('Dyskretne z progiem') ?>
                                <span id="discrete2">4,6,7,7,4,3,2,1,4</span>
                            </p>

                            <p>
                                <?= __('Tabele punktwe (bullet charts)') ?>
                                <br>
                        ...
                        <div class="col-sm-6">
                            <p>
                                <?= __('Niestandardowe kolory i rozmiary') ?>
                                <span id="linecustom">10,8,9,3,5,8,5,7</span>
                            </p>

                            <p>
                                <?= __('Wykresy trzech stanów') ?>
                                <span class="sparktristate">1,1,0,1,-1,-1,1,-1,0,0,1,1</span><br>
                                (<?= __('np. gry: wygrane, przegrane, zremisowane') ?>)
                            </p>

                            <p>
                                <?= __('Wykres trzech stanów z mapą kolorów') ?>:
                                <span class="sparktristatecols">1,2,0,2,-1,-2,1,-2,0,0,1,1</span>
                            </p>

                            <p>
                                <?= __('Wykres pudełkowy') ?>: <span class="sparkboxplot">4,27,34,52,54,59,61,68,78,82,85,87,91,93,100</span><br>
                                <?= __('Przedliczony wykres pudełkowy') ?>
                                <span class="sparkboxplotraw"><?= __('Ładowanie') ?>...</span>
                            </p>
