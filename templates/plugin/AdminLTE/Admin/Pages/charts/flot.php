        ...
        <div class="col-xs-12">
            ...
            <div class="box box-primary">
                <div class="box-header with-border">
                    ...
                    <h3 class="box-title"><?= __('Interaktywny wykres obszarowy') ?></h3>
        ...
        <div class="col-md-6">
            ...
            <div class="box box-primary">
                <div class="box-header with-border">
                    ...
                    <h3 class="box-title"><?= __('Wykres obszarowy (pełna szerokość)') ?></h3>
...
<script>
    $(function () {
        ...
        var donutData = [
            {label: 'Dane2', data: 30, color: '#3c8dbc'},
            {label: 'Dane3', data: 20, color: '#0073b7'},
            {label: 'Dane4', data: 50, color: '#00c0ef'}
        ]
